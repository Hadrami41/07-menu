...
export const categories: Category[] = [
  ...
  { id: 'pates', label: 'Pâtes', tint: '#9a6b3a', subtitle: 'sauce maison' },
...
export const products: Product[] = [
  ...
  },
  {
    ...
    name: 'Tacos Poulet',
    category: 'tacos',
    description: 'Tortilla, poulet, fromage fondu, sauce maison',
    price: 150,
  ...
  },
  {
    ...
    name: 'Tacos Mix',
    category: 'tacos',
    description: 'Tortilla, viande et poulet, fromage fondu, sauce',
    price: 200,
  ...
  },
  {
    ...
    name: 'Tacos Gratiné',
    category: 'tacos',
    description: 'Tortilla gratinée, viande, frites et sauce fromagère',
    price: 200,
    badge: 'NOUVEAU',
  ...
  },
  {
    ...
    name: 'Shawarma Mix',
    category: 'kebabs',
    description: 'Viande marinée mixte, pain libanais, légumes et sauce',
    price: 120,
  ...
  },
  {
    ...
    category: 'pates',
    description: 'Spaghetti, sauce bolognaise maison et parmesan',
    price: 150,
